<template>
  <q-page class="flex items-center justify-center">
    <div class="relative w-full max-w-md mx-auto h-full bg-amber">
      <div
      ...
      <div class="relative p-6 bg-white shadow-lg sm:rounded-3xl">
        <h1 class="text-3xl mb-4">Speak Teacher</h1>
...
const host = "https://ff59-2a0b-6204-41fa-e200-e1a6-a202-373f-2f2c.ngrok.io";
export default {
